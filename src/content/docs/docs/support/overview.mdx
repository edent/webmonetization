...
When you set up your WM configuration software, you link the software to your wallet. That link is all you need to pay web monetized pages. There's no per-site payment forms to complete, and neither the WM software nor your browser need to save card details.
