...
Now that you've web monetized your page, you can choose to [remove ads](/docs/resources/remove-ads), [provide exclusive content](/docs/resources/provide-exclusive-content), or respond to [`monetization` events](/docs/references/monetizationevent) in some other way when a web monetized visitor accesses your page.
