...
To make the documentation easier to follow, we use the term *digital wallet provider* to represent any ASE that's integrated with the Open Payments standard.
