...
The providers listed on this page have implemented <LinkOut href="https://openpayments.dev/">Open Payments</LinkOut> and can issue wallet addresses. You must have a wallet address to send and/or receive Web Monetization payments. 
...
The Interledger test wallet is an open-source application developed and maintained by the [Interledger Foundation](https://interledger.org). 

Visit the [Interledger test wallet](/docs/wallet-address/ilf-test-wallet) page for step-by-step instructions on creating an account and wallet address at [Rafiki.money](https://rafiki.money). 
